...
public class SkillBtn_Skill02_RageDash : MonoBehaviour
{

    static SkillBtn_Skill02_RageDash _instance = null;
    public static SkillBtn_Skill02_RageDash Instance()
    {
        return _instance;
    }//인스턴스화
    ...
    void Start()
    {
       ...
       SkillDataManager.Instance().LoadSkillData00(1);
        ...
        Debug.Log("레이지 대쉬 쿨다운타임 : " + coolTime);
    ...
    public void UseSkill02()
    {
        if (canUseSkill && GameObject.FindGameObjectWithTag("Player").GetComponent<PlayerController>().isSkill01 == false)
        {
            ...
            GameObject.FindGameObjectWithTag("Player").GetComponent<PlayerController>().Skiil02();
    ...
    IEnumerator PlaySfxRandom()
    {
        ...
        SoundManager.Instance.RandomSoundEffect(skill02);
